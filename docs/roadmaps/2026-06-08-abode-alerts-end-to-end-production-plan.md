...
| (dispatching) | WS6 pass 1 (re-run) | `lib/ingest/backfill.ts`, `scripts/backfill-44224.ts`, `app/api/ingest/backfill/route.ts` (WS6 lane); flag-only on WS5 adapter      | 2026-06-09 | dispatching                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Gate; then WS6 pass 2, then WS11/WS10 |

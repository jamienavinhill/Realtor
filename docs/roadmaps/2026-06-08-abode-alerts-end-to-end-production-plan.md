...
| WS14 docs layout + content                                                | pass 2 done (fixed mount-context window-scroll bug via wrapper-padding cancel + `overflow-hidden`; reduced-motion; 8 sections re-verified vs live code; verify GREEN; browser smoke operator-pending) |
